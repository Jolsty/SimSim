...
Node.js è un framework open-source che esegue codice JavaScript al di fuori da un browser. E' basato sul motore JavaScript V8 di Google ed è stato creato per rendere possibile la creazione di un server utilizzando un linguaggio di programmazione con la stessa sintassi di JavaScript (si parla del paradigma "JavaScript-everywhere"). Tra i vantaggi principali di Node.js abbiamo:
...
\begin{itemize}
	\item Path (\url{})
	\item Express (\url{})
	\item Body-Parser (\url{})
	\item EJS (\url{})
	\item Mongoose (\url{}) -- (si veda la sezione \ref{sec:db} "Database")
\end{itemize}
