...
\begin{figure}
	\center{\includegraphics[width=0.85\linewidth]{./img/esempio_libro_soci.png}}
...
NodeJS e suoi moduli (express, path, body-parser,view-engine ejs, mongoose con riferimento al db) \\
(si veda la sezione \ref{sec:db} "Database")
\subsubsection*{MVC}
