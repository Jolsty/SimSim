...
%\listoffigures % Da mettere?

%\listoftables % Da mettere?
...
\begin{figure}[H]
	\center{\includegraphics[width=0.65\linewidth]{./img/usecase.png}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\begin{center}
		...
		\captionof{figure}{Segnali PWM e comando analogWrite(int value) per generarli con l'Arduino. La \textit{Veff} è rappresentata dalla linea orizzontale che copre il segnale digitale}
		\label{fig:pwm}
	\end{center}
\end{wrapfigure}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.82\linewidth]{./img/esempio_libro_soci.png}}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.9\linewidth]{./img/logbook.png}}
